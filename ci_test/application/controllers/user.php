...
class User extends CI_Controller
{
    ...
    public function style() {
		...
		array_push($this->_data['js'], 'bootstrap-slider.min.js', 'tooltip.js', 'user_style.js');
    ...
    public function establishment() {
        ...
        array_push($this->_data['js'], 'bootstrap-slider.min.js', 'tooltip.js', 'user_establishment.js');
