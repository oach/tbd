							...
							<div class="col-xs-12 col-sm-8 col-md-8">
								<ul class="beer-review-info list-unstyled">
									...
									<li>
                                        ...
                                        <span class="label<?php echo $this->rating->getRatingsLabelClass($beer->drinkability); ?>" data-toggle="tooltip" data-placement="top" title="Drinkability - (<?php echo PERCENT_DRINKABILITY; ?>%)">D: <span class="bold"><?php echo $beer->drinkability; ?></span></span>  |
									...
									<li>Reviewed: <?php echo $beer->formatDateAdded; ?></li>
									<li>
									...
									<li>$<?php echo $beer->price; ?> for <?php echo $beer->package; ?></li>
<?php
...
?>			
									<li>
                                        ...
                                        Drinkability: <span class="bold"><?php echo $beer->drinkability; ?></span> (<?php echo PERCENT_DRINKABILITY; ?>%) |
                                        <span class="bold">Overall: <?php echo $beer->rating; ?></span>
									</li>
<?php									
		} else {
?>
									<li>Color: <?php echo $beer->color; ?></li>
...
?>
                        	...
                        	<div class="hidden-xs col-sm-4 col-md-4">
								<a href="<?php echo base_url(); ?>user/profile/<?php echo $beer->userID; ?>">
									<img src="<?php echo base_url() . ($beer->avatar && !empty($beer->avatarImage) ? 'images/avatars/' . $beer->avatarImage : 'images/fakepic.png'); ?>">
								</a>
