<?php
	...
	$drinkability = isset($form_data->drinkability) ? $form_data->drinkability : set_value('drinkability');
...
<?php
if (form_error('drinkability')) {
?>
		<div class="text-danger"><?php echo form_error('drinkability'); ?></div>		
<?php
}
?>	
		<div class="form-group">	
            <label for="drinkability"><span class="required">*</span> Drinkability (<?php echo PERCENT_DRINKABILITY; ?>% of the overall score): </label>
            <input type="text" class="form-control" id="drinkability" name="drinkability" placeholder="Drinkability" data-slider-value="<?php echo $drinkability; ?>" value="<?php echo $drinkability; ?>">
            <span class="help-block"></span>
        </div>        
...
?>	
    ...
    var percent_drinkability = (<?php echo PERCENT_DRINKABILITY; ?> / 100);
	</script>
