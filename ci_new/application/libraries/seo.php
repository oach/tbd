...
class Seo
{
	...
	public function getDynamicSEO($obj, $type)
    {
        ...
        } elseif ('google maps' == $type) {
            $seo->pageTitle = $obj->name . ' map including surrounding breweries, beer bars, and eateries - Two Beer Dudes';
            $seo->metaDescription = $obj->name . ' in ' . $obj->city . ', ' . $obj->stateFull . ', map and surrounding establishments near ' . $obj->address . ', ' . $obj->city . ', ' . $obj->stateFull;
            $seo->metaKeywords = $obj->name . ', ' . $obj->city . ', ' . $obj->stateFull . ', ' . $seo->metaKey_beer;
        }
