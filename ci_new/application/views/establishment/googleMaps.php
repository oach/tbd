...
?>
				<div class="alert alert-warning" role="alert">Geo coordinates for this establishment do not exist.</div>
<?php
	} else {
?>
...
?>							
		                    <li class="list-group-item">
		                    	<small>
		                    		<?php echo $count; ?>. <a href="<?php echo base_url(); ?>brewery/info/<?php echo $store->establishmentID; ?>/<?php echo $store->slug_establishment; ?>"><?php echo $store->name; ?></a> - <span class="bold"><?php echo number_format($store->distance, 2); ?></span> mile<?php echo $store->distance == 1.00 ? '' : 's'; ?>
		                    		<br>
...
?>
    ...
    establishment_locations.unshift(establishment_locations.pop());
	</script>
<?php
}
?>
