...
if (isset($not_logged_user_search)) {
?>
                <div class="alert alert-danger" role="alert">You must be logged in to search for users.</div>
<?php
} else if (isset($original_search_string)) {
?>
