			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-xs-12 col-sm-10 col-md-10">
						...
						<p>
							<span class="big-text label<?php echo $this->rating->getRatingsLabelClass($item->rating); ?>"><?php echo number_format(round($item->rating, 1), 1); ?></span> by 
...
?>
						<p class="ratingInfo">
							Overall Rating: <span class="big-text label<?php echo $this->rating->getRatingsLabelClass($ratingAverage); ?>"><?php echo number_format($ratingAverage, 1); ?></span> by 
