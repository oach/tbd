...
if (isset($message_info) && empty($this->input->post()))
{
    ...
    $subject = $this->visitor->adjustMailSubject($message_info->subject, 're');
	...
	<div class="container">
		<div class="row">
			<div class="col-md-9 col-xs-12">
				<h2 class="brown">Reply to <?php echo $message_info->username; ?></h2>
...
?>	
					<div class="form-group<?php echo (form_error('to') ? ' has-error': '');?>">	
                        ...
                        <input type="text" class="form-control" id="to" name="to" placeholder="To" value="<?php echo $to; ?>" readonly="readonly">
